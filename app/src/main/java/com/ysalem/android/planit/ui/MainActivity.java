...
import com.ysalem.android.planit.utils.BaseActivity;
import com.ysalem.android.planit.utils.ConnectionReceiver;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, "ca-app-pub-1347708863162478~9296884830" /*"ca-app-pub-3940256099942544~3347511713" *//*getString(R.string.adMob_appId)*/);

        mAdView = findViewById(R.id.adView);
        AdRequest adRequest = new AdRequest.Builder()
                .addTestDevice("3B8A555074A760EDEFA93CC22BFE556F")
                .build();
